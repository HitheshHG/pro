...
var root_2 = add_locations(template(`<title class="s-7BQRohUOa9R0"> </title>`), Fa[FILENAME], [[55, 6]]);
  ...
  var node = first_child(fragment);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      template_effect(() => {
        ...
        set_svg_class(svg, `svelte-fa svelte-fa-base ${clazz() ?? ""} s-7BQRohUOa9R0`);
        set_attribute(svg, "style", style());
        set_attribute(svg, "viewBox", `0 0 ${get(i)[0] ?? ""} ${get(i)[1] ?? ""}`);
        toggle_class(svg, "pulse", pulse());
        toggle_class(svg, "svelte-fa-size-lg", strict_equals(size(), "lg"));
        toggle_class(svg, "svelte-fa-size-sm", strict_equals(size(), "sm"));
        toggle_class(svg, "svelte-fa-size-xs", strict_equals(size(), "xs"));
        toggle_class(svg, "svelte-fa-fw", fw());
        toggle_class(svg, "svelte-fa-pull-left", strict_equals(pull(), "left"));
        toggle_class(svg, "svelte-fa-pull-right", strict_equals(pull(), "right"));
        toggle_class(svg, "spin", spin());
...
function Fa_layers($$anchor, $$props) {
  ...
  template_effect(() => {
    ...
    set_class(span, `svelte-fa-layers svelte-fa-base svelte-fa-fw ${clazz() ?? ""} s-EGrL2pmq8yhK`);
    set_attribute(span, "style", style());
    toggle_class(span, "svelte-fa-pull-left", strict_equals(pull(), "left"));
    toggle_class(span, "svelte-fa-pull-right", strict_equals(pull(), "right"));
    toggle_class(span, "svelte-fa-size-lg", strict_equals(size(), "lg"));
    toggle_class(span, "svelte-fa-size-sm", strict_equals(size(), "sm"));
    toggle_class(span, "svelte-fa-size-xs", strict_equals(size(), "xs"));
  });
  append($$anchor, span);
  return pop({ ...legacy_api() });
}
...
var root2 = add_locations(template(`<span><span class="svelte-fa-base container s-tc0a3-ah3Txe"><!></span></span>`), Fa_layers_text[FILENAME], [[24, 0, [[26, 2]]]]);
var $$css3 = {
  hash: "s-tc0a3-ah3Txe",
...
function Fa_layers_text($$anchor, $$props) {
  ...
  template_effect(() => {
    set_attribute(span, "id", id());
    set_class(span, `svelte-fa-layers-text ${clazz() ?? ""} s-tc0a3-ah3Txe`);
    set_attribute(span_1, "style", style());
    toggle_class(span_1, "svelte-fa-size-lg", strict_equals(size(), "lg"));
    toggle_class(span_1, "svelte-fa-size-sm", strict_equals(size(), "sm"));
    toggle_class(span_1, "svelte-fa-size-xs", strict_equals(size(), "xs"));
  });
  append($$anchor, span);
  return pop({ ...legacy_api() });
}
